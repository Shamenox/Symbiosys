...
scene.closet = function() {
    ...
    if (use === "slot2") setTimeout(normalize, 2000), Game.ctx.fillText("Thereï¿½s nothing in the closet...", 300, 40);
    if (use === "slot3") setTimeout(normalize, 2000), Game.ctx.fillText("Thereï¿½s nothing in the closet...", 300, 40);
    if (use === "slot4") setTimeout(normalize, 2000), Game.ctx.fillText("Thereï¿½s nothing in the closet...", 300, 40);
    if (use === "slot5") setTimeout(normalize, 2000), Game.ctx.fillText("Thereï¿½s nothing in the closet...", 300, 40);
}
